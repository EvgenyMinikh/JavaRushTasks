    ...
    public Sayable toSayable(final int i) {
        ...
        class DogPet extends SuperDog implements Sayable {
            ...
            public String say() {
                ...
                StringBuilder bark = new StringBuilder("г");
                for (int j = 0; j < i; j++) { bark.append("а"); }
                bark.append("в!");
                return  i < 1 ? String.format("%1$s%2$s%1$s спит.", getSuperQuotes(), name) : String.format("%1$s%2$s%1$s лает %3$s %4$s", getSuperQuotes(), name, bark, this.formatter.format(now));
            }
        }
